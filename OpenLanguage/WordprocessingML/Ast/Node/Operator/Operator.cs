...
namespace OpenLanguage.WordprocessingML.Ast
{
    ...
    public class EqualPrefixedNode : UnaryOperatorNode
    {
    ...
    public class UnaryEqualNode : UnaryOperatorNode
    {
        public UnaryEqualNode(
            ExpressionNode op,
            ExpressionNode operand,
            List<Node>? lws = null,
            List<Node>? tws = null
    ...
    public class UnaryNotEqualNode : UnaryOperatorNode
    {
        public UnaryNotEqualNode(
            ExpressionNode op,
            ExpressionNode operand,
            List<Node>? lws = null,
            List<Node>? tws = null
    ...
    public class UnaryLessThanNode : UnaryOperatorNode
    {
        public UnaryLessThanNode(
            ExpressionNode op,
            ExpressionNode operand,
            List<Node>? lws = null,
            List<Node>? tws = null
    ...
    public class UnaryLessThanOrEqualNode : UnaryOperatorNode
    {
        public UnaryLessThanOrEqualNode(
            ExpressionNode op,
            ExpressionNode operand,
            List<Node>? lws = null,
            List<Node>? tws = null
    ...
    public class UnaryGreaterThanNode : UnaryOperatorNode
    {
        public UnaryGreaterThanNode(
            ExpressionNode op,
            ExpressionNode operand,
            List<Node>? lws = null,
            List<Node>? tws = null
    ...
    public class UnaryGreaterThanOrEqualNode : UnaryOperatorNode
    {
        public UnaryGreaterThanOrEqualNode(
            ExpressionNode op,
            ExpressionNode operand,
            List<Node>? lws = null,
            List<Node>? tws = null
    ...
    public class PercentPrefixedNode : UnaryOperatorNode
    {
        public PercentPrefixedNode(
            ExpressionNode op,
            ExpressionNode operand,
            List<Node>? lws = null,
            List<Node>? tws = null
