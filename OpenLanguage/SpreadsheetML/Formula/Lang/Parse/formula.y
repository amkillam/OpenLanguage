...
%token <stringVal> T_LBRACK T_RBRACK
...
expression: T_LPAREN opt_whitespace expression opt_whitespace T_RPAREN { $$ = new ParenthesizedExpressionNode($3, $2, $4); }
    | expression opt_whitespace T_PLUS opt_whitespace expression         { $$ = new AddNode($1, new PlusOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_MINUS opt_whitespace expression        { $$ = new SubtractNode($1, new MinusOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_ASTERISK opt_whitespace expression     { $$ = new MultiplyNode($1, new AsteriskOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_SLASH opt_whitespace expression        { $$ = new DivideNode($1, new SlashOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_CARET opt_whitespace expression        { $$ = new PowerNode($1, new CaretOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_AMPERSAND opt_whitespace expression    { $$ = new ConcatenateNode($1, new AmpersandOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_NE opt_whitespace expression           { $$ = new NotEqualNode($1, new NotEqualOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_LE opt_whitespace expression           { $$ = new LessThanOrEqualNode($1, new LessThanOrEqualOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_LT opt_whitespace expression           { $$ = new LessThanNode($1, new LessThanOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_GE opt_whitespace expression           { $$ = new GreaterThanOrEqualNode($1, new GreaterThanOrEqualOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_GT opt_whitespace expression           { $$ = new GreaterThanNode($1, new GreaterThanOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_EQ opt_whitespace expression           { $$ = new EqualNode($1, new EqualOperatorLiteralNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_COLON opt_whitespace expression        { $$ = new RangeNode($1, new ColonNode($3, $2, $4), $5, null, null); }
    | expression opt_whitespace T_COMMA opt_whitespace expression        { $$ = new UnionNode($1, new CommaNode($3, $2, $4), $5, $4, $2, null, null); }
    | expression opt_whitespace T_PERCENT %prec T_PERCENT                { $$ = new PercentNode(new PercentOperatorLiteralNode($3, $2, null), $1, null, null); }
    | expression opt_whitespace T_HASH                                 { $$ = new DynamicNode(new HashOperatorLiteralNode($3, $2, null), $1, null, null); }
    | T_PLUS opt_whitespace expression %prec UMINUS                      { $$ = new UnaryPlusNode(new PlusOperatorLiteralNode($1, null, $2), $3, null, null); }
    | T_MINUS opt_whitespace expression %prec UMINUS                     { $$ = new UnaryMinusNode(new MinusOperatorLiteralNode($1, null, $2), $3, null, null); }
    | expression T_INTERSECTION opt_whitespace expression { $$ = new IntersectionNode($1, new IntersectionOperatorLiteralNode($2, null, null), $4, $3); }
    | T_AT_SYMBOL opt_whitespace expression %prec UMINUS { $$ = new ImplicitIntersectionNode(new AtSuffixNode($1, null, $2), $3, null, null); }
    | expression opt_whitespace T_AT_SYMBOL             { $$ = new AtSuffixNode(new AtSuffixNode($3, $2, null), $1, null, null); }
    | primary { $$ = $1; }
    ;
...
function_call_head: standard_function_name { $$ = new BuiltInStandardFunctionNode($1); }
    ...
    | opt_whitespace T_XLFN_XLWS_ opt_whitespace worksheet_function_name opt_whitespace { $$ = new BuiltInWorksheetFunctionNode($2, $4, $1.Concat($3).ToList(), $5); }
    ;
...
standard_function_name:
      T_FUNC_ABS { $$ = "ABS"; }
    | T_FUNC_ACCRINT { $$ = "ACCRINT"; }
    | T_FUNC_ACCRINTM { $$ = "ACCRINTM"; }
    | T_FUNC_ACOS { $$ = "ACOS"; }
    | T_FUNC_ACOSH { $$ = "ACOSH"; }
    | T_FUNC_ADDRESS { $$ = "ADDRESS"; }
    | T_FUNC_AMORDEGRC { $$ = "AMORDEGRC"; }
    | T_FUNC_AMORLINC { $$ = "AMORLINC"; }
    | T_FUNC_AND { $$ = "AND"; }
    | T_FUNC_AREAS { $$ = "AREAS"; }
    | T_FUNC_ASC { $$ = "ASC"; }
    | T_FUNC_ASIN { $$ = "ASIN"; }
    ...
    | T_FUNC_ATAN2 { $$ = "ATAN2"; }
    | T_FUNC_ATANH { $$ = "ATANH"; }
    | T_FUNC_AVEDEV { $$ = "AVEDEV"; }
    | T_FUNC_AVERAGE { $$ = "AVERAGE"; }
    | T_FUNC_AVERAGEA { $$ = "AVERAGEA"; }
    | T_FUNC_AVERAGEIF { $$ = "AVERAGEIF"; }
    | T_FUNC_AVERAGEIFS { $$ = "AVERAGEIFS"; }
    | T_FUNC_BAHTTEXT { $$ = "BAHTTEXT"; }
    | T_FUNC_BESSELI { $$ = "BESSELI"; }
    | T_FUNC_BESSELJ { $$ = "BESSELJ"; }
    | T_FUNC_BESSELK { $$ = "BESSELK"; }
    | T_FUNC_BESSELY { $$ = "BESSELY"; }
    | T_FUNC_BETADIST { $$ = "BETADIST"; }
    | T_FUNC_BETAINV { $$ = "BETAINV"; }
    | T_FUNC_BIN2DEC { $$ = "BIN2DEC"; }
    | T_FUNC_BIN2HEX { $$ = "BIN2HEX"; }
    | T_FUNC_BIN2OCT { $$ = "BIN2OCT"; }
    | T_FUNC_BINOMDIST { $$ = "BINOMDIST"; }
    | T_FUNC_CEILING { $$ = "CEILING"; }
    | T_FUNC_CELL { $$ = "CELL"; }
    | T_FUNC_CHAR { $$ = "CHAR"; }
    | T_FUNC_CHIDIST { $$ = "CHIDIST"; }
    | T_FUNC_CHIINV { $$ = "CHIINV"; }
    | T_FUNC_CHITEST { $$ = "CHITEST"; }
    | T_FUNC_CHOOSE { $$ = "CHOOSE"; }
    | T_FUNC_CLEAN { $$ = "CLEAN"; }
    | T_FUNC_CODE { $$ = "CODE"; }
    | T_FUNC_COLUMN { $$ = "COLUMN"; }
    | T_FUNC_COLUMNS { $$ = "COLUMNS"; }
    | T_FUNC_COMBIN { $$ = "COMBIN"; }
    | T_FUNC_COMPLEX { $$ = "COMPLEX"; }
    | T_FUNC_CONCAT { $$ = "CONCAT"; }
    | T_FUNC_CONCATENATE { $$ = "CONCATENATE"; }
    | T_FUNC_CONFIDENCE { $$ = "CONFIDENCE"; }
    | T_FUNC_CONVERT { $$ = "CONVERT"; }
    | T_FUNC_CORREL { $$ = "CORREL"; }
    | T_FUNC_COS { $$ = "COS"; }
    | T_FUNC_COSH { $$ = "COSH"; }
    | T_FUNC_COUNT { $$ = "COUNT"; }
    | T_FUNC_COUNTA { $$ = "COUNTA"; }
    | T_FUNC_COUNTBLANK { $$ = "COUNTBLANK"; }
    | T_FUNC_COUNTIF { $$ = "COUNTIF"; }
    | T_FUNC_COUNTIFS { $$ = "COUNTIFS"; }
    | T_FUNC_COUPDAYBS { $$ = "COUPDAYBS"; }
    | T_FUNC_COUPDAYS { $$ = "COUPDAYS"; }
    | T_FUNC_COUPDAYSNC { $$ = "COUPDAYSNC"; }
    | T_FUNC_COUPNCD { $$ = "COUPNCD"; }
    | T_FUNC_COUPNUM { $$ = "COUPNUM"; }
    | T_FUNC_COUPPCD { $$ = "COUPPCD"; }
    | T_FUNC_COVAR { $$ = "COVAR"; }
    | T_FUNC_CRITBINOM { $$ = "CRITBINOM"; }
    | T_FUNC_CUBEKPIMEMBER { $$ = "CUBEKPIMEMBER"; }
    | T_FUNC_CUBEMEMBER { $$ = "CUBEMEMBER"; }
    | T_FUNC_CUBEMEMBERPROPERTY { $$ = "CUBEMEMBERPROPERTY"; }
    | T_FUNC_CUBERANKEDMEMBER { $$ = "CUBERANKEDMEMBER"; }
    | T_FUNC_CUBESET { $$ = "CUBESET"; }
    | T_FUNC_CUBESETCOUNT { $$ = "CUBESETCOUNT"; }
    | T_FUNC_CUBEVALUE { $$ = "CUBEVALUE"; }
    | T_FUNC_CUMIPMT { $$ = "CUMIPMT"; }
    | T_FUNC_CUMPRINC { $$ = "CUMPRINC"; }
    | T_FUNC_DATE { $$ = "DATE"; }
    | T_FUNC_DATEDIF { $$ = "DATEDIF"; }
    | T_FUNC_DATESTRING { $$ = "DATESTRING"; }
    | T_FUNC_DATEVALUE { $$ = "DATEVALUE"; }
    | T_FUNC_DAVERAGE { $$ = "DAVERAGE"; }
    | T_FUNC_DAY { $$ = "DAY"; }
    | T_FUNC_DAYS360 { $$ = "DAYS360"; }
    | T_FUNC_DB { $$ = "DB"; }
    | T_FUNC_DBCS { $$ = "DBCS"; }
    | T_FUNC_DCOUNT { $$ = "DCOUNT"; }
    | T_FUNC_DCOUNTA { $$ = "DCOUNTA"; }
    | T_FUNC_DDB { $$ = "DDB"; }
    | T_FUNC_DEC2BIN { $$ = "DEC2BIN"; }
    | T_FUNC_DEC2HEX { $$ = "DEC2HEX"; }
    | T_FUNC_DEC2OCT { $$ = "DEC2OCT"; }
    | T_FUNC_DEGREES { $$ = "DEGREES"; }
    | T_FUNC_DELTA { $$ = "DELTA"; }
    | T_FUNC_DEVSQ { $$ = "DEVSQ"; }
    | T_FUNC_DGET { $$ = "DGET"; }
    | T_FUNC_DISC { $$ = "DISC"; }
    | T_FUNC_DMAX { $$ = "DMAX"; }
    | T_FUNC_DMIN { $$ = "DMIN"; }
    | T_FUNC_DOLLAR { $$ = "DOLLAR"; }
    | T_FUNC_DOLLARDE { $$ = "DOLLARDE"; }
    | T_FUNC_DOLLARFR { $$ = "DOLLARFR"; }
    | T_FUNC_DPRODUCT { $$ = "DPRODUCT"; }
    | T_FUNC_DSTDEV { $$ = "DSTDEV"; }
    | T_FUNC_DSTDEVP { $$ = "DSTDEVP"; }
    | T_FUNC_DSUM { $$ = "DSUM"; }
    | T_FUNC_DURATION { $$ = "DURATION"; }
    | T_FUNC_DVAR { $$ = "DVAR"; }
    | T_FUNC_DVARP { $$ = "DVARP"; }
    | T_FUNC_EDATE { $$ = "EDATE"; }
    | T_FUNC_EFFECT { $$ = "EFFECT"; }
    | T_FUNC_EOMONTH { $$ = "EOMONTH"; }
    | T_FUNC_ERF { $$ = "ERF"; }
    | T_FUNC_ERFC { $$ = "ERFC"; }
    | T_FUNC_ERROR_TYPE { $$ = "ERROR.TYPE"; }
    | T_FUNC_EVEN { $$ = "EVEN"; }
    | T_FUNC_EXACT { $$ = "EXACT"; }
    | T_FUNC_EXP { $$ = "EXP"; }
    | T_FUNC_EXPONDIST { $$ = "EXPONDIST"; }
    | T_FUNC_FACT { $$ = "FACT"; }
    | T_FUNC_FACTDOUBLE { $$ = "FACTDOUBLE"; }
    | T_FUNC_FDIST { $$ = "FDIST"; }
    | T_FUNC_FIND { $$ = "FIND"; }
    | T_FUNC_FINDB { $$ = "FINDB"; }
    | T_FUNC_FINV { $$ = "FINV"; }
    | T_FUNC_FISHER { $$ = "FISHER"; }
    | T_FUNC_FISHERINV { $$ = "FISHERINV"; }
    | T_FUNC_FIXED { $$ = "FIXED"; }
    | T_FUNC_FLOOR { $$ = "FLOOR"; }
    | T_FUNC_FORECAST { $$ = "FORECAST"; }
    | T_FUNC_FREQUENCY { $$ = "FREQUENCY"; }
    | T_FUNC_FTEST { $$ = "FTEST"; }
    | T_FUNC_FV { $$ = "FV"; }
    | T_FUNC_FVSCHEDULE { $$ = "FVSCHEDULE"; }
    | T_FUNC_GAMMADIST { $$ = "GAMMADIST"; }
    | T_FUNC_GAMMAINV { $$ = "GAMMAINV"; }
    | T_FUNC_GAMMALN { $$ = "GAMMALN"; }
    | T_FUNC_GCD { $$ = "GCD"; }
    | T_FUNC_GEOMEAN { $$ = "GEOMEAN"; }
    | T_FUNC_GESTEP { $$ = "GESTEP"; }
    | T_FUNC_GETPIVOTDATA { $$ = "GETPIVOTDATA"; }
    | T_FUNC_GROWTH { $$ = "GROWTH"; }
    | T_FUNC_HARMEAN { $$ = "HARMEAN"; }
    | T_FUNC_HEX2BIN { $$ = "HEX2BIN"; }
    | T_FUNC_HEX2DEC { $$ = "HEX2DEC"; }
    | T_FUNC_HEX2OCT { $$ = "HEX2OCT"; }
    | T_FUNC_HLOOKUP { $$ = "HLOOKUP"; }
    | T_FUNC_HOUR { $$ = "HOUR"; }
    | T_FUNC_HYPERLINK { $$ = "HYPERLINK"; }
    | T_FUNC_HYPGEOMDIST { $$ = "HYPGEOMDIST"; }
    | T_FUNC_IF { $$ = "IF"; }
    | T_FUNC_IFERROR { $$ = "IFERROR"; }
    | T_FUNC_IFS { $$ = "IFS"; }
    | T_FUNC_IMABS { $$ = "IMABS"; }
    | T_FUNC_IMAGINARY { $$ = "IMAGINARY"; }
    | T_FUNC_IMARGUMENT { $$ = "IMARGUMENT"; }
    | T_FUNC_IMCONJUGATE { $$ = "IMCONJUGATE"; }
    | T_FUNC_IMCOS { $$ = "IMCOS"; }
    | T_FUNC_IMDIV { $$ = "IMDIV"; }
    | T_FUNC_IMEXP { $$ = "IMEXP"; }
    | T_FUNC_IMLN { $$ = "IMLN"; }
    | T_FUNC_IMLOG10 { $$ = "IMLOG10"; }
    | T_FUNC_IMLOG2 { $$ = "IMLOG2"; }
    | T_FUNC_IMPOWER { $$ = "IMPOWER"; }
    | T_FUNC_IMPRODUCT { $$ = "IMPRODUCT"; }
    | T_FUNC_IMREAL { $$ = "IMREAL"; }
    | T_FUNC_IMSIN { $$ = "IMSIN"; }
    | T_FUNC_IMSQRT { $$ = "IMSQRT"; }
    | T_FUNC_IMSUB { $$ = "IMSUB"; }
    | T_FUNC_IMSUM { $$ = "IMSUM"; }
    | T_FUNC_INDEX { $$ = "INDEX"; }
    | T_FUNC_INDIRECT { $$ = "INDIRECT"; }
    | T_FUNC_INFO { $$ = "INFO"; }
    | T_FUNC_INT { $$ = "INT"; }
    | T_FUNC_INTERCEPT { $$ = "INTERCEPT"; }
    | T_FUNC_INTRATE { $$ = "INTRATE"; }
    | T_FUNC_IPMT { $$ = "IPMT"; }
    | T_FUNC_IRR { $$ = "IRR"; }
    | T_FUNC_ISBLANK { $$ = "ISBLANK"; }
    | T_FUNC_ISERR { $$ = "ISERR"; }
    | T_FUNC_ISERROR { $$ = "ISERROR"; }
    | T_FUNC_ISEVEN { $$ = "ISEVEN"; }
    | T_FUNC_ISLOGICAL { $$ = "ISLOGICAL"; }
    | T_FUNC_ISNA { $$ = "ISNA"; }
    | T_FUNC_ISNONTEXT { $$ = "ISNONTEXT"; }
    | T_FUNC_ISNUMBER { $$ = "ISNUMBER"; }
    | T_FUNC_ISODD { $$ = "ISODD"; }
    | T_FUNC_ISPMT { $$ = "ISPMT"; }
    | T_FUNC_ISREF { $$ = "ISREF"; }
    | T_FUNC_ISTEXT { $$ = "ISTEXT"; }
    | T_FUNC_ISTHAIDIGIT { $$ = "ISTHAIDIGIT"; }
    | T_FUNC_KURT { $$ = "KURT"; }
    | T_FUNC_LARGE { $$ = "LARGE"; }
    | T_FUNC_LCM { $$ = "LCM"; }
    | T_FUNC_LEFT { $$ = "LEFT"; }
    ...
    | T_FUNC_LEN { $$ = "LEN"; }
    | T_FUNC_LENB { $$ = "LENB"; }
    | T_FUNC_LINEST { $$ = "LINEST"; }
    | T_FUNC_LN { $$ = "LN"; }
    | T_FUNC_LOG { $$ = "LOG"; }
    | T_FUNC_LOG10 { $$ = "LOG10"; }
    | T_FUNC_LOGEST { $$ = "LOGEST"; }
    | T_FUNC_LOGINV { $$ = "LOGINV"; }
    | T_FUNC_LOGNORMDIST { $$ = "LOGNORMDIST"; }
    | T_FUNC_LOOKUP { $$ = "LOOKUP"; }
    | T_FUNC_LOWER { $$ = "LOWER"; }
    | T_FUNC_MATCH { $$ = "MATCH"; }
    | T_FUNC_MAX { $$ = "MAX"; }
    | T_FUNC_MAXA { $$ = "MAXA"; }
    | T_FUNC_MAXIFS { $$ = "MAXIFS"; }
    | T_FUNC_MDETERM { $$ = "MDETERM"; }
    | T_FUNC_MDURATION { $$ = "MDURATION"; }
    | T_FUNC_MEDIAN { $$ = "MEDIAN"; }
    | T_FUNC_MID { $$ = "MID"; }
    | T_FUNC_MIDB { $$ = "MIDB"; }
    | T_FUNC_MIN { $$ = "MIN"; }
    | T_FUNC_MINA { $$ = "MINA"; }
    | T_FUNC_MINIFS { $$ = "MINIFS"; }
    | T_FUNC_MINUTE { $$ = "MINUTE"; }
    | T_FUNC_MINVERSE { $$ = "MINVERSE"; }
    | T_FUNC_MIRR { $$ = "MIRR"; }
    | T_FUNC_MMULT { $$ = "MMULT"; }
    | T_FUNC_MOD { $$ = "MOD"; }
    | T_FUNC_MODE { $$ = "MODE"; }
    | T_FUNC_MONTH { $$ = "MONTH"; }
    | T_FUNC_MROUND { $$ = "MROUND"; }
    | T_FUNC_MULTINOMIAL { $$ = "MULTINOMIAL"; }
    | T_FUNC_N { $$ = "N"; }
    | T_FUNC_NA { $$ = "NA"; }
    | T_FUNC_NEGBINOMDIST { $$ = "NEGBINOMDIST"; }
    | T_FUNC_NETWORKDAYS { $$ = "NETWORKDAYS"; }
    | T_FUNC_NOMINAL { $$ = "NOMINAL"; }
    | T_FUNC_NORMDIST { $$ = "NORMDIST"; }
    | T_FUNC_NORMINV { $$ = "NORMINV"; }
    | T_FUNC_NORMSDIST { $$ = "NORMSDIST"; }
    | T_FUNC_NORMSINV { $$ = "NORMSINV"; }
    | T_FUNC_NOT { $$ = "NOT"; }
    | T_FUNC_NOW { $$ = "NOW"; }
    | T_FUNC_NPER { $$ = "NPER"; }
    | T_FUNC_NPV { $$ = "NPV"; }
    | T_FUNC_NUMBERSTRING { $$ = "NUMBERSTRING"; }
    | T_FUNC_OCT2BIN { $$ = "OCT2BIN"; }
    | T_FUNC_OCT2DEC { $$ = "OCT2DEC"; }
    | T_FUNC_OCT2HEX { $$ = "OCT2HEX"; }
    | T_FUNC_ODD { $$ = "ODD"; }
    | T_FUNC_ODDFPRICE { $$ = "ODDFPRICE"; }
    | T_FUNC_ODDFYIELD { $$ = "ODDFYIELD"; }
    | T_FUNC_ODDLPRICE { $$ = "ODDLPRICE"; }
    | T_FUNC_ODDLYIELD { $$ = "ODDLYIELD"; }
    | T_FUNC_OFFSET { $$ = "OFFSET"; }
    | T_FUNC_OR { $$ = "OR"; }
    | T_FUNC_PEARSON { $$ = "PEARSON"; }
    | T_FUNC_PERCENTILE { $$ = "PERCENTILE"; }
    | T_FUNC_PERCENTRANK { $$ = "PERCENTRANK"; }
    | T_FUNC_PERMUT { $$ = "PERMUT"; }
    | T_FUNC_PHONETIC { $$ = "PHONETIC"; }
    | T_FUNC_PI { $$ = "PI"; }
    | T_FUNC_PMT { $$ = "PMT"; }
    | T_FUNC_POISSON { $$ = "POISSON"; }
    | T_FUNC_POWER { $$ = "POWER"; }
    | T_FUNC_PPMT { $$ = "PPMT"; }
    | T_FUNC_PRICE { $$ = "PRICE"; }
    | T_FUNC_PRICEDISC { $$ = "PRICEDISC"; }
    | T_FUNC_PRICEMAT { $$ = "PRICEMAT"; }
    | T_FUNC_PROB { $$ = "PROB"; }
    | T_FUNC_PRODUCT { $$ = "PRODUCT"; }
    | T_FUNC_PROPER { $$ = "PROPER"; }
    | T_FUNC_PV { $$ = "PV"; }
    | T_FUNC_QUARTILE { $$ = "QUARTILE"; }
    | T_FUNC_QUOTIENT { $$ = "QUOTIENT"; }
    | T_FUNC_RADIANS { $$ = "RADIANS"; }
    | T_FUNC_RAND { $$ = "RAND"; }
    | T_FUNC_RANDBETWEEN { $$ = "RANDBETWEEN"; }
    | T_FUNC_RANK { $$ = "RANK"; }
    | T_FUNC_RATE { $$ = "RATE"; }
    | T_FUNC_RECEIVED { $$ = "RECEIVED"; }
    | T_FUNC_REPLACE { $$ = "REPLACE"; }
    | T_FUNC_REPLACEB { $$ = "REPLACEB"; }
    | T_FUNC_REPT { $$ = "REPT"; }
    | T_FUNC_RIGHT { $$ = "RIGHT"; }
    | T_FUNC_RIGHTB { $$ = "RIGHTB"; }
    | T_FUNC_ROMAN { $$ = "ROMAN"; }
    | T_FUNC_ROUND { $$ = "ROUND"; }
    | T_FUNC_ROUNDBAHTDOWN { $$ = "ROUNDBAHTDOWN"; }
    | T_FUNC_ROUNDBAHTUP { $$ = "ROUNDBAHTUP"; }
    | T_FUNC_ROUNDDOWN { $$ = "ROUNDDOWN"; }
    | T_FUNC_ROUNDUP { $$ = "ROUNDUP"; }
    | T_FUNC_ROW { $$ = "ROW"; }
    | T_FUNC_ROWS { $$ = "ROWS"; }
    | T_FUNC_RSQ { $$ = "RSQ"; }
    | T_FUNC_RTD { $$ = "RTD"; }
    | T_FUNC_SEARCH { $$ = "SEARCH"; }
    | T_FUNC_SEARCHB { $$ = "SEARCHB"; }
    | T_FUNC_SECOND { $$ = "SECOND"; }
    | T_FUNC_SERIES { $$ = "SERIES"; }
    | T_FUNC_SERIESSUM { $$ = "SERIESSUM"; }
    | T_FUNC_SIGN { $$ = "SIGN"; }
    | T_FUNC_SIN { $$ = "SIN"; }
    | T_FUNC_SINH { $$ = "SINH"; }
    | T_FUNC_SKEW { $$ = "SKEW"; }
    ...
    | T_FUNC_SMALL { $$ = "SMALL"; }
    | T_FUNC_SQRT { $$ = "SQRT"; }
    | T_FUNC_SQRTPI { $$ = "SQRTPI"; }
    | T_FUNC_STANDARDIZE { $$ = "STANDARDIZE"; }
    | T_FUNC_STDEV { $$ = "STDEV"; }
    | T_FUNC_STDEVA { $$ = "STDEVA"; }
    | T_FUNC_STDEVP { $$ = "STDEVP"; }
    | T_FUNC_STDEVPA { $$ = "STDEVPA"; }
    | T_FUNC_STEYX { $$ = "STEYX"; }
    | T_FUNC_SUBSTITUTE { $$ = "SUBSTITUTE"; }
    | T_FUNC_SUBTOTAL { $$ = "SUBTOTAL"; }
    | T_FUNC_SUM { $$ = "SUM"; }
    | T_FUNC_SUMIF { $$ = "SUMIF"; }
    | T_FUNC_SUMIFS { $$ = "SUMIFS"; }
    | T_FUNC_SUMPRODUCT { $$ = "SUMPRODUCT"; }
    | T_FUNC_SUMSQ { $$ = "SUMSQ"; }
    | T_FUNC_SUMX2MY2 { $$ = "SUMX2MY2"; }
    | T_FUNC_SUMX2PY2 { $$ = "SUMX2PY2"; }
    | T_FUNC_SUMXMY2 { $$ = "SUMXMY2"; }
    | T_FUNC_SWITCH { $$ = "SWITCH"; }
    | T_FUNC_SYD { $$ = "SYD"; }
    | T_FUNC_T { $$ = "T"; }
    | T_FUNC_TAN { $$ = "TAN"; }
    | T_FUNC_TANH { $$ = "TANH"; }
    | T_FUNC_TBILLEQ { $$ = "TBILLEQ"; }
    | T_FUNC_TBILLPRICE { $$ = "TBILLPRICE"; }
    | T_FUNC_TBILLYIELD { $$ = "TBILLYIELD"; }
    | T_FUNC_TDIST { $$ = "TDIST"; }
    | T_FUNC_TEXT { $$ = "TEXT"; }
    | T_FUNC_TEXTJOIN { $$ = "TEXTJOIN"; }
    | T_FUNC_THAIDAYOFWEEK { $$ = "THAIDAYOFWEEK"; }
    | T_FUNC_THAIDIGIT { $$ = "THAIDIGIT"; }
    | T_FUNC_THAIMONTHOFYEAR { $$ = "THAIMONTHOFYEAR"; }
    | T_FUNC_THAINUMSOUND { $$ = "THAINUMSOUND"; }
    | T_FUNC_THAINUMSTRING { $$ = "THAINUMSTRING"; }
    | T_FUNC_THAISTRINGLENGTH { $$ = "THAISTRINGLENGTH"; }
    | T_FUNC_THAIYEAR { $$ = "THAIYEAR"; }
    | T_FUNC_TIME { $$ = "TIME"; }
    | T_FUNC_TIMEVALUE { $$ = "TIMEVALUE"; }
    | T_FUNC_TINV { $$ = "TINV"; }
    | T_FUNC_TODAY { $$ = "TODAY"; }
    | T_FUNC_TRANSPOSE { $$ = "TRANSPOSE"; }
    | T_FUNC_TREND { $$ = "TREND"; }
    | T_FUNC_TRIM { $$ = "TRIM"; }
    | T_FUNC_TRIMMEAN { $$ = "TRIMMEAN"; }
    | T_FUNC_TRUNC { $$ = "TRUNC"; }
    | T_FUNC_TTEST { $$ = "TTEST"; }
    | T_FUNC_TYPE { $$ = "TYPE"; }
    | T_FUNC_UPPER { $$ = "UPPER"; }
    | T_FUNC_USDOLLAR { $$ = "USDOLLAR"; }
    | T_FUNC_VALUE { $$ = "VALUE"; }
    | T_FUNC_VAR { $$ = "VAR"; }
    | T_FUNC_VARA { $$ = "VARA"; }
    | T_FUNC_VARP { $$ = "VARP"; }
    | T_FUNC_VARPA { $$ = "VARPA"; }
    | T_FUNC_VDB { $$ = "VDB"; }
    | T_FUNC_VLOOKUP { $$ = "VLOOKUP"; }
    | T_FUNC_WEEKDAY { $$ = "WEEKDAY"; }
    | T_FUNC_WEEKNUM { $$ = "WEEKNUM"; }
    | T_FUNC_WEIBULL { $$ = "WEIBULL"; }
    | T_FUNC_WORKDAY { $$ = "WORKDAY"; }
    | T_FUNC_XIRR { $$ = "XIRR"; }
    | T_FUNC_XNPV { $$ = "XNPV"; }
    | T_FUNC_YEAR { $$ = "YEAR"; }
    | T_FUNC_YEARFRAC { $$ = "YEARFRAC"; }
    | T_FUNC_YIELD { $$ = "YIELD"; }
    | T_FUNC_YIELDDISC { $$ = "YIELDDISC"; }
    | T_FUNC_YIELDMAT { $$ = "YIELDMAT"; }
    | T_FUNC_ZTEST { $$ = "ZTEST"; }
;
