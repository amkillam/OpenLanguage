...
namespace OpenLanguage.WordprocessingML.FieldInstruction.Tests
{
  public class FieldInstructionTests
  {
    ...
    {
      // Act
      OpenLanguage.FieldInstruction fieldInstruction = new OpenLanguage.FieldInstruction(
        instruction
      );
    ...
    {
      // Act & Assert
      Assert.Throws<ArgumentException>(() => new OpenLanguage.FieldInstruction(instruction!));
    }
    ...
    public void Arguments_CanBeModified()
    {
      ...
      // Act
      fieldInstruction.Arguments.Add(new FieldArgument(FieldArgumentType.Switch, "\\* Upper"));
    ...
    public void Equality_SameInstructionAndArguments_ReturnsTrue()
    {
      ...
      OpenLanguage.FieldInstruction fieldInstruction1 = new OpenLanguage.FieldInstruction(
        "PAGE",
        arguments
      );
      OpenLanguage.FieldInstruction fieldInstruction2 = new OpenLanguage.FieldInstruction(
        "PAGE",
        arguments
      );
    ...
    {
      // Arrange & Act
      OpenLanguage.FieldInstruction upperCase = new OpenLanguage.FieldInstruction("PAGE");
      OpenLanguage.FieldInstruction lowerCase = new OpenLanguage.FieldInstruction("page");
      OpenLanguage.FieldInstruction mixedCase = new OpenLanguage.FieldInstruction("Page");
  ...
  public class FieldArgumentTests
  {
    ...
    {
      // Arrange
      OpenLanguage.FieldInstruction nestedField = new OpenLanguage.FieldInstruction(
        "DATE"
      );
    ...
    public void ToString_ReturnsValueAsString(FieldArgumentType type, object value, string expected)
    {
      // Arrange
      FieldArgument argument = new FieldArgument(type, value);
  ...
  public class EnumTests
  {
    ...
    public void CountryRegionInclusion_HasAllExpectedValues()
    {
      ...
      // Act
      IEnumerable<CountryRegionInclusion> actualValues = Enum.GetValues<CountryRegionInclusion>();
