...
namespace OpenLanguage.WordprocessingML.FieldInstruction.Tests
{
  ...
  public class TestTypedFieldInstruction : TypedFieldInstruction
  {
    ...
    public TestTypedFieldInstruction(OpenLanguage.FieldInstruction source)
      : base(source) { }
  ...
  public class TypedFieldInstructionTests
  {
    ...
    {
      // Arrange
      OpenLanguage.FieldInstruction source = new OpenLanguage.FieldInstruction("TEST");
    ...
    {
      // Arrange
      OpenLanguage.FieldInstruction source = new OpenLanguage.FieldInstruction(
        instruction
      );
    ...
    {
      // Arrange
      OpenLanguage.FieldInstruction source1 = new OpenLanguage.FieldInstruction("TEST1");
      OpenLanguage.FieldInstruction source2 = new OpenLanguage.FieldInstruction("TEST2");
  ...
  public class TypedFieldInstructionFactoryTests
  {
    ...
    {
      // Arrange
      OpenLanguage.FieldInstruction source = FieldParser.Parse(
    ...
    {
      // Arrange
      OpenLanguage.FieldInstruction source = new OpenLanguage.FieldInstruction("PAGE");
